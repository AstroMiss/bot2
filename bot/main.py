...
def main():
    ...
    text21 = [t.text for t in text_elements]
    chunks22 = chunk_text_by_characters(text21, 500)
    embeddings22 = [embed_text(chunk) for chunk in chunks22]
    store_embeddings_in_pinecone(embeddings22, chunks22)
